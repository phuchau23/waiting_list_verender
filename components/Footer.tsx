      ...
      <div className="mx-auto max-w-6xl px-6 py-10 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1.6fr] gap-10 md:gap-8 items-start">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-xl bg-linear-to-br from-red-500 to-red-400 flex items-center justify-center text-xs font-bold text-white">
                V
              </div>
              <span className="text-lg font-semibold text-gray-800">Verendar</span>
            </div>
            <p className="text-xs md:text-sm text-gray-600 max-w-xs leading-relaxed">
              Verendar giúp bạn theo dõi bảo dưỡng, chi phí và lịch sử sửa chữa cho từng chiếc xe – đơn giản và trực
              quan.
            </p>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <button className="h-9 px-4 rounded-lg border border-red-100 bg-red-50/50 text-[11px] text-gray-700 flex items-center gap-2">
                ...
                <span className="leading-tight text-left">
                  <span className="block text-[9px] uppercase tracking-[0.16em] text-gray-500">Get it on</span>
              ...
              <button className="h-9 px-4 rounded-lg border border-red-100 bg-red-50/50 text-[11px] text-gray-700 flex items-center gap-2">
                <span className="text-base"></span>
                <span className="leading-tight text-left">
                  <span className="block text-[9px] uppercase tracking-[0.16em] text-gray-500">Download on the</span>
          ...
          <div className="space-y-4">
            <div>
              <h4 className="text-sm font-semibold text-gray-800 mb-2">Nhận thông tin mới nhất</h4>
            ...
            <div>
              <p className="text-xs text-gray-600 mb-2">Kết nối với chúng tôi:</p>
        ...
        <div className="mt-10 pt-6 border-t border-red-100 text-center">
          <p className="text-[11px] text-gray-500">
            Copyright © {new Date().getFullYear()} Verendar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
