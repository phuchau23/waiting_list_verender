            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm md:text-base text-white/60 max-w-md">
                  Có câu hỏi, góp ý hay ý tưởng tính năng mới cho Verender? Hãy
                  gửi cho chúng tôi – đội ngũ luôn sẵn sàng lắng nghe và đồng
                  hành cùng hành trình chăm xe của bạn.
                </p>
              </div>
            </div>
          ...
          <div className="contact-form p-8 md:p-10 lg:p-12">
            ...
            >
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full md:w-auto rounded-full bg-emerald-400 px-8 py-3 text-sm font-semibold text-black shadow-[0_14px_40px_rgba(16,185,129,0.45)] hover:bg-emerald-300 transition-colors"
                >
                  Submit
                </button>
              </div>
              ...
              <p className="text-[11px] text-white/40 pt-1">
                Bằng cách gửi form, bạn đồng ý để Verender liên hệ lại qua email
                hoặc số điện thoại bạn cung cấp.
              </p>
            </form>
          </div>
        </div>
